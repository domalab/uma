...
func (h *DocsHandler) addSystemPaths(paths map[string]interface{}) {
	...
	paths["/api/v1/system/info"] = h.createGetEndpoint("System", "Get system information", "Retrieve general system information", "SystemInfo")
	paths["/api/v1/system/cpu"] = h.createGetEndpoint("System", "Get CPU information", "Retrieve CPU usage and information", "CPUInfo")
	paths["/api/v1/system/memory"] = h.createGetEndpoint("System", "Get memory information", "Retrieve memory usage and information", "MemoryInfo")
	paths["/api/v1/system/temperature"] = h.createGetEndpoint("System", "Get temperature information", "Retrieve system temperature data", "TemperatureInfo")
	paths["/api/v1/system/fans"] = h.createGetEndpoint("System", "Get fan information", "Retrieve fan speed and status", "FanInfo")
	paths["/api/v1/system/gpu"] = h.createGetEndpoint("System", "Get GPU information", "Retrieve comprehensive GPU monitoring data including utilization, memory usage, power consumption, and vendor-specific metrics", "GPUInfo")
	paths["/api/v1/system/ups"] = h.createGetEndpoint("System", "Get UPS information", "Retrieve UPS status and battery information", "UPSInfo")
	paths["/api/v1/system/network"] = h.createGetEndpoint("System", "Get network information", "Retrieve network interface information", "NetworkInfo")
	paths["/api/v1/system/resources"] = h.createGetEndpoint("System", "Get system resources", "Retrieve comprehensive system resource information", "SystemResources")
	paths["/api/v1/system/filesystems"] = h.createGetEndpoint("System", "Get filesystem information", "Retrieve filesystem usage information", "FilesystemInfo")
	paths["/api/v1/system/logs"] = h.createGetEndpoint("System", "Get system logs", "Retrieve system log entries", "SystemLogs")

	// System control endpoints
	paths["/api/v1/system/reboot"] = h.createPostEndpoint("System", "Reboot system", "Initiate system reboot", "SystemOperationResponse")
	paths["/api/v1/system/shutdown"] = h.createPostEndpoint("System", "Shutdown system", "Initiate system shutdown", "SystemOperationResponse")

	// Parity endpoints
	paths["/api/v1/system/parity/disk"] = h.createGetEndpoint("System", "Get parity disk information", "Retrieve parity disk status and information", "ParityDiskInfo")
...
func (h *DocsHandler) addStoragePaths(paths map[string]interface{}) {
	...
	paths["/api/v1/storage/array"] = h.createGetEndpoint("Storage", "Get array status", "Retrieve Unraid array status and information", "ArrayStatus")
	paths["/api/v1/storage/disks"] = h.createGetEndpoint("Storage", "List storage disks", "Retrieve list of all storage disks", "DiskList")
	paths["/api/v1/storage/cache"] = h.createGetEndpoint("Storage", "Get cache information", "Retrieve cache pool information", "CacheInfo")
	paths["/api/v1/storage/boot"] = h.createGetEndpoint("Storage", "Get boot device information", "Retrieve boot device usage and information", "BootInfo")
	paths["/api/v1/storage/zfs"] = h.createGetEndpoint("Storage", "Get ZFS information", "Retrieve ZFS pool and dataset information", "ZFSInfo")
	paths["/api/v1/storage/general"] = h.createGetEndpoint("Storage", "Get general storage information", "Retrieve general storage usage information", "StorageGeneral")

	// Storage control endpoints
	paths["/api/v1/storage/array/start"] = h.createPostEndpoint("Storage", "Start array", "Start the Unraid array", "ArrayOperationResponse")
	paths["/api/v1/storage/array/stop"] = h.createPostEndpoint("Storage", "Stop array", "Stop the Unraid array", "ArrayOperationResponse")
}
...
func (h *DocsHandler) addDockerPaths(paths map[string]interface{}) {
	...
	paths["/api/v1/docker/containers"] = h.createGetEndpoint("Docker", "List Docker containers", "Retrieve list of Docker containers", "DockerContainerList")
	paths["/api/v1/docker/images"] = h.createGetEndpoint("Docker", "List Docker images", "Retrieve list of Docker images", "DockerImageList")
	paths["/api/v1/docker/networks"] = h.createGetEndpoint("Docker", "List Docker networks", "Retrieve list of Docker networks", "DockerNetworkList")
	paths["/api/v1/docker/info"] = h.createGetEndpoint("Docker", "Get Docker information", "Retrieve Docker system information", "DockerInfo")

	// Docker container control endpoints
	paths["/api/v1/docker/containers/{id}"] = map[string]interface{}{
	...
	paths["/api/v1/docker/containers/bulk/start"] = h.createPostEndpoint("Docker", "Bulk start containers", "Start multiple containers", "BulkOperationResponse")
	paths["/api/v1/docker/containers/bulk/stop"] = h.createPostEndpoint("Docker", "Bulk stop containers", "Stop multiple containers", "BulkOperationResponse")
	paths["/api/v1/docker/containers/bulk/restart"] = h.createPostEndpoint("Docker", "Bulk restart containers", "Restart multiple containers", "BulkOperationResponse")
}

// addVMPaths adds all VM management endpoints
func (h *DocsHandler) addVMPaths(paths map[string]interface{}) {
	paths["/api/v1/vms"] = h.createGetEndpoint("Virtual Machines", "List virtual machines", "Retrieve list of virtual machines", "VMList")
	...
	paths["/api/v1/vms/{name}/stats"] = h.createGetEndpoint("Virtual Machines", "Get VM statistics", "Retrieve performance statistics for a VM", "VMStats")
	paths["/api/v1/vms/{name}/snapshots"] = map[string]interface{}{
...
func (h *DocsHandler) addMetricsPaths(paths map[string]interface{}) {
	paths["/metrics"] = map[string]interface{}{
		"get": map[string]interface{}{
			...
			"description": "Retrieve Prometheus-formatted metrics for monitoring and alerting systems",
			...
			"responses": map[string]interface{}{
				"200": map[string]interface{}{
					...
					"content": map[string]interface{}{
						"text/plain; version=0.0.4; charset=utf-8": map[string]interface{}{
							"schema": map[string]interface{}{
								"type":        "string",
								"description": "Prometheus metrics in standard text format",
								"example":     "# HELP uma_http_requests_total Total number of HTTP requests\n# TYPE uma_http_requests_total counter\numa_http_requests_total{method=\"GET\",endpoint=\"/api/v1/health\",status_code=\"200\"} 42",
							},
						},
					},
				},
...
func (h *DocsHandler) addWebSocketPaths(paths map[string]interface{}) {
	paths["/api/v1/ws"] = h.createGetEndpoint("WebSocket", "Unified WebSocket with subscription management", "Real-time updates via WebSocket with subscription management for system stats, Docker events, storage status, temperature alerts, and more", "UnifiedWebSocketStream")
}
...
func (h *DocsHandler) addNotificationPaths(paths map[string]interface{}) {
	paths["/api/v1/notifications"] = map[string]interface{}{
	...
	paths["/api/v1/notifications/{id}"] = map[string]interface{}{
	...
	paths["/api/v1/notifications/clear"] = h.createPostEndpoint("Notifications", "Clear all notifications", "Clear all notifications", "NotificationResponse")
	paths["/api/v1/notifications/stats"] = h.createGetEndpoint("Notifications", "Get notification statistics", "Retrieve notification statistics", "NotificationStats")
	paths["/api/v1/notifications/mark-all-read"] = h.createPostEndpoint("Notifications", "Mark all as read", "Mark all notifications as read", "NotificationResponse")
}

// addAsyncPaths adds async operation endpoints
func (h *DocsHandler) addAsyncPaths(paths map[string]interface{}) {
	paths["/api/v1/operations"] = h.createGetEndpoint("Async Operations", "List operations", "Retrieve list of async operations", "OperationList")
	paths["/api/v1/operations/{id}"] = h.createGetEndpoint("Async Operations", "Get operation", "Retrieve a specific async operation", "OperationInfo")
	paths["/api/v1/operations/stats"] = h.createGetEndpoint("Async Operations", "Get operation statistics", "Retrieve async operation statistics", "OperationStats")
}

// addDiagnosticsPaths adds diagnostic endpoints
func (h *DocsHandler) addDiagnosticsPaths(paths map[string]interface{}) {
	paths["/api/v1/diagnostics/health"] = h.createGetEndpoint("Diagnostics", "System health diagnostics", "Retrieve comprehensive system health diagnostics", "DiagnosticsHealth")
	paths["/api/v1/diagnostics/info"] = h.createGetEndpoint("Diagnostics", "System diagnostic information", "Retrieve system diagnostic information", "DiagnosticsInfo")
	paths["/api/v1/diagnostics/repair"] = h.createPostEndpoint("Diagnostics", "Run system repair", "Run system diagnostic repair operations", "DiagnosticsRepair")
}
